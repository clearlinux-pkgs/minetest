...
%prep
%setup -q -n minetest-5.1.1
cd %{_builddir}/minetest-5.1.1
...
cp %{_builddir}/minetest-5.1.1/fonts/Arimo-LICENSE.txt %{buildroot}/usr/share/package-licenses/minetest/b1b13828a3a2be603b24a38d3948c7811d85f851
cp %{_builddir}/minetest-5.1.1/fonts/Cousine-LICENSE.txt %{buildroot}/usr/share/package-licenses/minetest/2b1b42e96714bc36f7bee9210a5e69e2586f7ee3
cp %{_builddir}/minetest-5.1.1/fonts/DroidSansFallbackFull-LICENSE.txt %{buildroot}/usr/share/package-licenses/minetest/2f6f017f448a7c197950c1d4a0907a9990845eb1
cp %{_builddir}/minetest-5.1.1/lib/lua/COPYRIGHT %{buildroot}/usr/share/package-licenses/minetest/a6efc4d11f332f4843bc25b557c6bf3e5ef51458
pushd clr-build
%make_install
popd
