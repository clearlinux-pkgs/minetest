...
Version  : 5.8.0
Release  : 48
URL      : https://github.com/minetest/minetest/archive/5.8.0/minetest-5.8.0.tar.gz
Source0  : https://github.com/minetest/minetest/archive/5.8.0/minetest-5.8.0.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0 CC-BY-SA-3.0 LGPL-2.1 LGPL-2.1+ MIT
...
%prep
%setup -q -n minetest-5.8.0
cd %{_builddir}/minetest-5.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701983265
mkdir -p clr-build
pushd clr-build
