...
Source0  : https://github.com/minetest/minetest/archive/5.9.0/minetest-5.9.0.tar.gz
...
%prep
%setup -q -n minetest-5.9.0
cd %{_builddir}/minetest-5.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723487811
mkdir -p clr-build
pushd clr-build
